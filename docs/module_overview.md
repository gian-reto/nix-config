...
- `modules/phone.nix`: Contains features that are only relevant for phones (e.g., Fairphone).
- `modules/server.nix`: Contains features that are only relevant for servers.
